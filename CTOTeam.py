...
def helptext ():
        ...
        print " EX. python2 CTOTeam.py www.website.com/ip taget -t 1000 -c 1000 -p 80"
        print ""
        ...
        print ""
        print " UPDATES!!! 1.5 PATCH UDP DDOS"
        print ""
        print " NEW CODER ( C.T.O LORENZY)"
        print ""
        print ""
        print "" 
        ...
        print ""
        print " Lorenzy"
        print "Contact for any BUGS or GLITCHES on WhatShapp 082164957967. Your feedback is helpfull"
        exit()
...
def sender (num):
        ...
        col()
        print " * | CyberTimedout %d started" % num
        ...
        while True:
                ...
                for i in range (connection_amount):
                        ...
                        try:
                                ...
                                col()
                                print " # | - Server Get Rip%d: Dadah Server Gay [Server Noob Down Asu]" % num
                                bleh = True
                if bleh:
                        continue
